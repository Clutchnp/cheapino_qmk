...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_A, LCTL_T(KC_S), LALT_T(KC_D), LSFT_T(KC_F), KC_G,     KC_H, LSFT_T(KC_J), LALT_T(KC_K), LCTL_T(KC_L), KC_TAB,
        KC_Z, KC_X, KC_C, KC_V, KC_B,                             KC_N, KC_M, KC_LALT, KC_DQUO, LCTL_T(KC_QUOT),
               LM(2, MOD_LGUI), KC_SPC,MO(4),             MO(3), LT(3, KC_BSPC), LT(6, KC_ESC)
    ),
//Windows default layer
    [1] = LAYOUT_split_3x5_3(
        ...
        LM(2, MOD_LALT), KC_SPC,MO(4),            MO(3), LT(3, KC_BSPC), LT(6, KC_ESC)
            ),
    ...
    [3] = LAYOUT_split_3x5_3(
        ...
        KC_SCLN, KC_PIPE, KC_SLSH, KC_CIRC, KC_UNDS,     KC_RBRC, KC_EQL, KC_BSLS, KC_AT, KC_ASTR,
                          KC_LSFT, KC_ENTER,KC_PLUS,     DF(1), KC_ENT, DF(7)
    ),
    ...
    [4] = LAYOUT_split_3x5_3(
        ...
        KC_MINS, KC_7, KC_8, KC_9, KC_MINS,               KC_WH_D, KC_F7, KC_F8, KC_F9, KC_F12,
...
[6] = LAYOUT_split_3x5_3(
    ...
    LSFT(KC_Q), LCTL(LSFT(KC_W)), LCTL(LSFT(KC_D)), KC_DEL, LSFT(KC_V),      LCTL(KC_TAB),KC_NO,KC_NO,KC_NO,LSFT(KC_A),
    LSFT(KC_A),LCTL(LALT(KC_C)), KC_F, KC_F13, LCTL(LALT(KC_S)),             KC_H,KC_J,KC_K,KC_L,KC_NO,
    LSFT(KC_Z),KC_BTN1, KC_BTN2, KC_NO, LCTL(LSFT(KC_T)),         KC_NO,KC_NO,KC_NO, KC_NO,KC_NO,
    ...
    [7] = LAYOUT_split_3x5_3(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V,                KC_NO, KC_NO, KC_NO, KC_NO, KC_RCTL,
          LM(9, MOD_LGUI), KC_SPC,MO(8),                DF(0), KC_SPC, MO(10)
    ),
