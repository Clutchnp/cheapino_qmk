...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,           KC_H,    KC_J,    KC_K,    KC_L,            KC_LSFT,
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,           KC_N,    KC_M,    KC_DOUBLE_QUOTE, KC_QUOT, KC_TAB,
        LM(3, MOD_LGUI),  KC_SPACE,         KC_LCTL,        KC_LALT, LT(1,KC_BSPC),    LT(4,KC_ESC)),
